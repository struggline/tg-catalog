...
Список команд:
/newsearch — запуск нового сеанса поиска, сброс всех текущих параметров;
/clear — очистка истории текущего диалога и сброс выбранных фильтров;
/help — справка по основным функциям и возможностям чат\\-бота\\.
